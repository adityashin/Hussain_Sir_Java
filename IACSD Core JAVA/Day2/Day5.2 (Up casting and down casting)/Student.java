...
public class Student extends Person {
    ...
    public String toString(){
        return "Student "+super.toString()+" Year grade is "+grade_year+" and Course details are "+course+" and fees of the course is "+fees+" and marks he got for that course is "+marks;
    }
}
